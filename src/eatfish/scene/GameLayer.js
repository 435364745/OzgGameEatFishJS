...
eatfish.scene.GameLayer = eatfish.scene.BaseLayer.extend({
	...
	onLayerTouchBegan: function(touch, event) {
	...
	onLayerTouchEnded: function(touch, event) {

	},
	//点击事件 end

	enemyFishEmergence: function(enemyFishNode) {
		var startPoint = null;
		var endPoint = null;
	...
	enemyFishRandomLeftPoint: function(enemyFishNode) {
		var winSize = cc.director.getWinSize();
	...
	enemyFishRandomRightPoint: function(enemyFishNode) {
		var winSize = cc.director.getWinSize();
	...
	changePlayerLife: function(playerLife) {
	...
	onDialogBtnYes: function(sender) {
		this.unscheduleUpdate();
