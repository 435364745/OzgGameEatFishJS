	...
	ctor:function (type) {		
		...
		switch (this.type) {
			case eatfish.element.EnemyFishType.fish2:
				this.animSpriteList = eatfish.element.animData.fish2;
			...
			case eatfish.element.EnemyFishType.fish3:
				this.animSpriteList = eatfish.element.animData.fish3;
			...
			case eatfish.element.EnemyFishType.fish4:
				this.animSpriteList = eatfish.element.animData.fish4;
			...
			case eatfish.element.EnemyFishType.fish5:
				this.animSpriteList = eatfish.element.animData.fish5;
			...
			case eatfish.element.EnemyFishType.fish6:
				this.animSpriteList = eatfish.element.animData.fish6;
				this.animKey = cfg.animKeyEnemyFish6;
				this.elementName = eatfish.element.Name.enemtyFish6;
				
				break;
			default:
				this.animSpriteList = eatfish.element.animData.fish1;
		...
		enemyFish.setTag(eatfish.element.BaseNodeTag.mainObj);
